...
//
//    val spock =  new Result("1555")
//    val spockAsJson = """{\"res\":\"16\",\"json\":\"data\"}"""
//
//    // add name value pairs to a post object
//    val post = new HttpPost("http://localhost:8081/result")
...
//    response.getAllHeaders.foreach(arg => println(arg))
  ...
  val result = Http("http://localhost:8081/result").postData("""{"res":"166","json":"data"}""")
